    ...
    return (
        <div className={`flex flex-col min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
            ...
            <main className="flex-grow max-w-5xl mx-auto px-4 py-12">
                ...
                <h1 className={`text-3xl font-bold mb-8 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Contact Us</h1>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-md p-8`}>
                        <h2 className={`text-xl font-semibold mb-4 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Get in Touch</h2>
                        <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-6`}>We're here to help with any questions or concerns. Reach out to us through the following methods or send us an email directly.</p>

                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                <div className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 text-green-400' : 'bg-gray-100 text-green-700'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 className={`font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Location</h3>
                                    <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>P. Tuazon Blvd, Cubao, Quezon City, Metro Manila</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 text-green-400' : 'bg-gray-100 text-green-700'}`}>
                                ...
                                <div>
                                    <h3 className={`font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Email</h3>
                                    <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>phellconetv@support.com</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 text-green-400' : 'bg-gray-100 text-green-700'}`}>
                                ...
                                <div>
                                    <h3 className={`font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Phone</h3>
                                    <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>+63 123 456 7890</p>
                                </div>
                            </div>
                        </div>
                        <a
                            href="mailto:phellconetv@support.com"
                            className={`mt-6 inline-block w-full text-center py-3 rounded-lg text-white font-semibold transition-all duration-200 ${theme === 'dark' ? 'bg-green-500 hover:bg-green-600' : 'bg-green-600 hover:bg-green-700'}`}
                        >
                            Contact Support
                        </a>
                    </div>
                    <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-md p-8`}>
                        <h2 className={`text-xl font-semibold mb-4 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Business Hours</h2>
                        <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-6`}>Our team is available during the following hours. For urgent matters, please email us.</p>
                        <div className="space-y-3">
                            <div className="flex justify-between">
                                <span className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Monday - Friday</span>
                                <span className={`${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} font-medium`}>9:00 AM - 6:00 PM</span>
                            </div>
                            <div className="flex justify-between">
                                <span className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Saturday</span>
                                <span className={`${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} font-medium`}>10:00 AM - 4:00 PM</span>
                            </div>
                            <div className="flex justify-between">
                                <span className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Sunday & Holidays</span>
                                <span className={`${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} font-medium`}>Closed</span>
                            </div>
                        </div>
                        <div className="mt-8 pt-6 border-t border-gray-200">
                            <h3 className={`text-sm font-medium mb-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Customer Support</h3>
                            <p className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>For immediate assistance, our support team is just an email away. We strive to respond within 24-48 hours.</p>
                        </div>
                    </div>
                </div>
            </main>
